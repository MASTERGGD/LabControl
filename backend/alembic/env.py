...
from models import (               # noqa: E402
    ...
    notificacion, password_reset, sesion, usuario, usuario_permiso, auditoria, adeudo, espacio, comunicado, departamento, calendario_academico, cierre_academico, promocion_academica,
)
