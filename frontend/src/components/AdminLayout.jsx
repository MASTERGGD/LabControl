...
const NAV_ITEMS = [
  ...
  {
    label: 'Préstamos', path: '/admin/prestamos', roles: ['SUPER_ADMIN','LAB_ADMIN','RESPONSABLE_LAB'], inGroup: true,
  ...
  {
    label: 'Mantenimiento', path: '/admin/mantenimiento', roles: ['SUPER_ADMIN','LAB_ADMIN','RESPONSABLE_LAB'], permiso: 'inventario:validar', inGroup: true,
...
const BREADCRUMB_MAP = {
  ...
  '/admin/inventario/bajas':  [{ label: 'Inventario' }],
  '/admin/inventario/levantamientos': [{ label: 'Inventario' }],
