...
export default function HistorialClasesDocente() {
  ...
  const resumen = useMemo(() => {
    ...
    return { impartidas, pendientes: filtradas.length - impartidas, asistencia: alumnos ? Math.round((presentes / alumnos) * 100) : null };
  }, [filtradas]);
